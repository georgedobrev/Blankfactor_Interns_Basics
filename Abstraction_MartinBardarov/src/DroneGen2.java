public class DroneGen2 extends Drone implements GPS {


    private final String generation = "Generation 2";

    Map map = new Map(10);


    public DroneGen2(String model, int batteryPercentage, int coordinateX, int getCoordinateY) {
